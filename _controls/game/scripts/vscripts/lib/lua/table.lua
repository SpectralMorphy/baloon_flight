...
function table.print( t, tParams, _tPrinted )	
	...
	qPrint[1] = ( tParams.bKey and tFormat.sKeyPrefix or tFormat.sValuePrefix ) .. qPrint[1]
	qPrint[ #qPrint ] =  qPrint[ #qPrint ] .. ( tParams.bKey and tFormat.sKeyPostfix or tFormat.sValuePostfix )
